...
import com.example.dashboard.components.Inicio
...
//        verticalArrangement = Arrangement.spacedBy(3.dp),
        ...
        items(listaProductosInici) { producto ->
            ProductCardInici(producto = producto)
        }
    }
}

val listaProductosInici = listOf(
   Inicio.Inicio1,
   Inicio.Inicio2,
   Inicio.Inicio3,
   Inicio.Inicio4,
...
@Composable
private fun ProductCardInici(producto: Inicio) {
