...
//        verticalArrangement = Arrangement.spacedBy(3.dp),
        ...
        items(listaProductosContenido) { producto ->
            ProductCardContenido(producto = producto)
        }
    }
}

val listaProductosContenido = listOf(
...
@Composable
fun ProductCardContenido(producto: Contenido) {
